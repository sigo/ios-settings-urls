...
\
`prefs:root=ROOT#AIRPLANE_MODE` _<sub>(centers it on the screen, but doesn't highlight it)</sub>_
\
\
\
_Wi-Fi_
...
_VPN (switch)_
\
`prefs:root=ROOT#VPN` _<sub>(centers it on the screen, but doesn't highlight it)</sub>_
\
\
\
_General_
